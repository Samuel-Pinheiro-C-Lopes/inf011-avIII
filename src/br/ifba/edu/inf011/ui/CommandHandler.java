...
public class CommandHandler {
	...
	public void criarDocumentoPublico() {
		this.documentCommand = documentCommand.addChild(new );
	}
	
	public void criarDocumentoPrivado() {
		this.documentCommand = documentCommand.addChild(new CriarDocumentoCommand(null, null, null));
	}
